        ...
        <div className="max-w-2xl mx-auto">
          ...
          <div className="card bg-base-100">
            <div className="card-body">
              <div className="form-control mb-6 ml-8">
                ...
                <input
                  ...
                  className="input input-bordered ml-10 w-125 "
                  value={note.title}
              ...
              <div className="form-control mb-6">
                <label className="label">
                  <span className="label-text ml-6">Content:</span>
                </label>
                <textarea
                  placeholder="Write your note here..."
                  className="textarea textarea-bordered h-32 ml-7 w-125"
                  value={note.content}
